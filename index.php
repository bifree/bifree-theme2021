...
<main>
    ...
    <section class="about">
        ...
        <div class="container">
            <p class="about__text text--justify">任意団体Bifreeは2021年2月22日、LGBTQ当事者とその理解者・支援者であるアライの人々により結成され、「人と人を結ぶウェブメディア」としてこのサイトを公開し活動を開始しました。そのウェブメディアを開設する上で活用したウェブ制作の技術で、更に多くの人を繋ぐことが出来るのではないか…そう考え、ウェブメディア運営からウェブ制作へ活動の主軸を移しました。メンバーも日本人のみならず、海外から参加をしてくれる…そんなインターナショナルな組織へと変貌も遂げました。<br>事業を展開する中で更に多くのLGBTQ当事者に限らない人々を巻き込み、全ての人がその人らしく生きていける、そんな世界を目指してこの先も邁進していきます。</p>
        </div>
        ...
        <div class="container">
            <div class="services service__web">
                <div class="service__text">
                    ...
                    <p class="service__body text--justify">LGBTQ当事者の雇用をもっと促進したい…その為のきっかけとなるべく始めたこの事業は、今やBifreeの根幹を大きく担っています。クライアントからのヒアリングを重視し、それを黙々と形にする、地味ですがとてもやりがいのある業務です。個人でなく、組織で行っているからこそのスピード感と、柔軟性は日々磨きをかけているところです。</p>
                </div>
            ...
            <div class="services service__media">
                <div class="service__text">
                    ...
                    <p class="service__body text--justify">登録者数600人に迫る「じゃらんじゃらんちゃんねる」ではLGBTQ当事者へのインタビューをメインに行っており、「LGBTQ当事者はどこにでもいる、当たり前の存在なんだ」とみなさまに知っていただくきっかけ作りを行っています。RPAの技術やPremiere Proを使っての編集がメインです。現状、動画制作の受託案件は承っておりません。</p>
                </div>
                <div class="service__img">
            ...
            <div class="services service__lgbt">
                <div class="service__text">
                    ...
                    <p class="service__body text--justify">Bifreeでは活動で得た収益の一部を、毎月LGBTQ関係の支援団体様へ寄付しております。他、ニーズがあれば当事者による講演会や勉強会・その出演も承っておりますのでお声掛けください。これから先、更に多くの人に「特別な存在でないこと」を発信していければと考えております。</p>
                </div>
                <div class="service__img">
